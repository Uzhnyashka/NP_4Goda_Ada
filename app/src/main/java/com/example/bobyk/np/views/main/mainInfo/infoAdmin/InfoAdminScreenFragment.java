package com.example.bobyk.np.views.main.mainInfo.infoAdmin;
...
public class InfoAdminScreenFragment extends Fragment {
    ...
    public static InfoAdminScreenFragment newInstance() {
        Bundle args = new Bundle();
        InfoAdminScreenFragment fragment = new InfoAdminScreenFragment();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_info_admin_screen, null);
